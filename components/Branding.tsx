  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center">
        ...
        >
          {/* Aesthetic 8-tooth Gear (Subtle scale to guarantee no clipping) */}
          <g transform="scale(0.96) translate(2, 2)">
            <path d="M92.5,41.9c-1-0.9-2.3-1.4-3.7-1.4h-6.2c-0.8-3.4-2.1-6.6-4-9.5l4.4-4.4c1-1,1.5-2.3,1.5-3.7s-0.5-2.7-1.5-3.7l-4.4-4.4 c-2-2-5.3-2-7.3,0l-4.4,4.4c-2.9-1.9-6.1-3.2-9.5-4V8.9c0-2.8-2.3-5.2-5.2-5.2s-5.2,2.3-5.2,5.2v6.2c-3.4,0.8-6.6,2.1-9.5,4 l-4.4-4.4c-1-1-2.3-1.5-3.7-1.5s-2.7,0.5-3.7,1.5l-4.4,4.4c-2,2-2,5.3,0,7.3l4.4,4.4c-1.9,2.9-3.2,6.1-4,9.5H8.9 c-2.8,0-5.2,2.3-5.2,5.2s2.3,5.2,5.2,5.2h6.2c0.8,3.4,2.1,6.6,4,9.5l-4.4,4.4c-1,1-1.5,2.3-1.5,3.7s0.5,2.7,1.5,3.7l4.4,4.4 c2,2,5.3,2,7.3,0l4.4-4.4c2.9,1.9,6.1,3.2,9.5,4v6.2c0,2.8,2.3,5.2,5.2,5.2s5.2-2.3,5.2-5.2v-6.2c3.4-0.8,6.6-2.1,9.5-4l4.4,4.4 c1,1,2.3,1.5,3.7,1.5s2.7-0.5,3.7-1.5l4.4-4.4c2-2,2-5.3,0-7.3l-4.4-4.4c1.9-2.9,3.2-6.1,4-9.5h6.2c2.8,0,5.2-2.3,5.2-5.2 S95.3,41.9,92.5,41.9z M50,67.5c-9.7,0-17.5-7.8-17.5-17.5s7.8-17.5,17.5-17.5S67.5,40.3,67.5,50S59.7,67.5,50,67.5z" />
          </g>
          {/* Inner circle hole */}
